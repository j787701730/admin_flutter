                    ...
                    Expanded(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                              ...
                              items: pricingClass.keys.toList().map<DropdownMenuItem<String>>((item) {
                    ...
                    Expanded(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                              ...
                              items: pricingStrategySel.keys.toList().map<DropdownMenuItem<String>>((item) {
                                return DropdownMenuItem(
                                  value: '$item',
                                  child: Container(
                                    padding: EdgeInsets.only(left: 10),
...
//                                                            padding: EdgeInsets.only(left: 5, right: 5),
                                                            ...
                                                            width: '${item['name']}'.length * 18.0 + 20,
                                                            height: 26,
                                                            alignment: Alignment.center,
                                                          ),
                                                          Container(
                                          ...
                                          child: TextField(
                                            controller: TextEditingController.fromValue(TextEditingValue(
                                                ...
                                                selection: TextSelection.fromPosition(TextPosition(
                                                    affinity: TextAffinity.downstream,
                                                    offset:
                                                        '${pricingStrategyData['pricing_strategy']['pricing_amount']}'
                                                            .length)))),
                                            decoration: InputDecoration(
                                                border: OutlineInputBorder(),
                                                  ...
                                                  children: <Widget>[
                                                    Container(
                                                      ...
                                                      child: TextField(
                                                        ...
                                                        decoration: InputDecoration(
                                                            border: OutlineInputBorder(),
                                                            contentPadding:
                                                                EdgeInsets.only(top: 6, bottom: 6, left: 10)),
                                                        onChanged: (val) {
                                                          setState(() {
                                                    ...
                                                    Container(
                                                      ...
                                                      child: DropdownButton<String>(
                                                          ...
                                                          items:
                                                              unit.keys.toList().map<DropdownMenuItem<String>>((item) {
                                                            return DropdownMenuItem(
                                                              value: '$item',
                                                              child: Container(
                                                                padding: EdgeInsets.only(left: 10),
                                                                child: Text('${unit[item]['attr_unit_ch_name']}'),
                                                              ),
                                                            );
                                                          }).toList()),
                                                    ),
                                                        ...
                                                        if (pricingStrategyData['pricing_strategy'].length == 1) {
                                                          setState(() {
                                                            ...
                                                            pricingStrategyData['pricing_strategy'][0]['upper_limit'] =
                                                                '';
                                                            pricingStrategyData['pricing_strategy'][0]
                                                                ['pricing_amount'] = '';
                                                          });
                                                        } else {
                                                          setState(() {
                                    ...
                                    children: <Widget>[
                                      Container(
                                        ...
                                        child: PrimaryButton(
                                          onPressed: () {
                                            Map line =
                                                jsonDecode(jsonEncode(pricingStrategyData['pricing_strategy'][0]));
                                            line['lower_limit'] = '';
                                            line['upper_limit'] = '';
                                            line['pricing_amount'] = '';
                                            setState(() {
