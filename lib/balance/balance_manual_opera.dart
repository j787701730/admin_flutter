...
class _BalanceManualOperaState extends State<BalanceManualOpera> {
  Map manualType = {"1": '商城现金', "3": '云端计费', "4": '云端计费-赠送', "5": '经销商'};
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Expanded(
                          flex: 1,
                          child:
                              widget.props == null || (widget.props != null && widget.props['manualTypeFlag'] == true)
                                  ? Container(
                                      ...
                                      child: DropdownButton<String>(
                                          ...
                                          items: manualType.keys.toList().map<DropdownMenuItem<String>>((item) {
                                            return DropdownMenuItem(
                                              value: '$item',
                                              child: Container(
                                                padding: EdgeInsets.only(left: 10),
                                                child: Text('${manualType[item]}'),
                                              ),
                                            );
                                          }).toList()),
                                    )
                                  : Container(
                                      height: 34,
                                      alignment: Alignment.centerLeft,
                                      child: Text('${manualType[widget.props['manualType']]}'),
                                    ))
                    ],
                  ),
                ),
                              ...
                              Offstage(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        border:
                                            Border.all(color: manualState == '1' ? Colors.red : Colors.grey, width: 2)),
                                    height: 30,
                                    alignment: Alignment.centerLeft,
                                    child: Row(
                                      children: <Widget>[
                              ...
                              Offstage(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          border: Border.all(
                                              color: manualState == '2' ? Colors.red : Colors.grey, width: 2)),
                                      height: 30,
                                      alignment: Alignment.centerLeft,
                                      child: Row(
                                        children: <Widget>[
