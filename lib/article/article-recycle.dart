...
class ArticleRecycleContent extends StatefulWidget {
  final Function getData;
  final List ajaxData;

  ArticleRecycleContent({this.getData, this.ajaxData});

  @override
  _ArticleRecycleContentState createState() => _ArticleRecycleContentState();
}

class _ArticleRecycleContentState extends State<ArticleRecycleContent> {
