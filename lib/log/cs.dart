...
class CsLogs extends StatefulWidget {
  @override
  _CsLogsState createState() => _CsLogsState();
}

class _CsLogsState extends State<CsLogs> {
  int curr_page = 1;
  int page_count = 20;
  Map param = {};
  List logs = [];
...
//  }
  ...
  getData({isRefresh: false}) async {
    ...
    ajax('Adminrelas-Logs-CsLogs', par, true, (res) {
      if (mounted) {
        setState(() {
          logs = res['data'];
