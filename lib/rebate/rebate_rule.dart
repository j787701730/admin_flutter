                        ...
                        controller: TextEditingController.fromValue(
                          TextEditingValue(
                            ...
                            selection: TextSelection.fromPosition(
                              TextPosition(
                                  affinity: TextAffinity.downstream, offset: '${param['min_charge'] ?? ''}'.length),
                            ),
                          ),
                        ),
                      ...
                      child: TextField(
                        ...
                        controller: TextEditingController.fromValue(TextEditingValue(
                            ...
                            selection: TextSelection.fromPosition(TextPosition(
                                affinity: TextAffinity.downstream, offset: '${param['plus_charge'] ?? ''}'.length)))),
                        decoration: InputDecoration(
                            border: OutlineInputBorder(), contentPadding: EdgeInsets.only(top: 0, bottom: 0, left: 15)),
                        onChanged: (String val) {
                          setState(() {
              ...
              Container(
                  ...
                  child: Row(children: <Widget>[
                    ...
                    Expanded(
                      flex: 1,
                      child: Row(
                        children: <Widget>[PrimaryButton(onPressed: () {}, child: Text('保存'))],
                      ),
                    ),
                  ]))
