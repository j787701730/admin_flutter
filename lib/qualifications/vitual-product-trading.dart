...
class VitualProductTrading extends StatefulWidget {
  @override
  _VitualProductTradingState createState() => _VitualProductTradingState();
}

class _VitualProductTradingState extends State<VitualProductTrading> {
  ...
  List columns = [
    ...
    {'title': '社会信用代码', 'key': 'SERVICE_SHOP_SOCIAL_CREDIT_CODE'},
    {'title': '营业执照', 'key': 'SERVICE_SHOP_BUSINESS_LICENSE'},
