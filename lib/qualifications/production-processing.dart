...
class ProductionProcessing extends StatefulWidget {
  @override
  _ProductionProcessingState createState() => _ProductionProcessingState();
}

class _ProductionProcessingState extends State<ProductionProcessing> {
  ...
  List columns = [
    ...
    {'title': '施工类型', 'key': 'SERVICE_CONSTRUCTION_TYPE'},
