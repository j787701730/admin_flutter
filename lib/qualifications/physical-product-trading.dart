...
class PhysicalProductTrading extends StatefulWidget {
  @override
  _PhysicalProductTradingState createState() => _PhysicalProductTradingState();
}

class _PhysicalProductTradingState extends State<PhysicalProductTrading> {
  ...
  List columns = [
    ...
    {'title': '培训类型', 'key': 'SERVICE_TRAIN_TYPE'},
