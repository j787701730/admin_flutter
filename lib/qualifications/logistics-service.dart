...
class LogisticsService extends StatefulWidget {
  @override
  _LogisticsServiceState createState() => _LogisticsServiceState();
}

class _LogisticsServiceState extends State<LogisticsService> {
  ...
  List columns = [
    ...
    {'title': '物流类型', 'key': 'SERVICE_LOGISTICS_TYPE'},
