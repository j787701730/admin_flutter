...
class DesigningService extends StatefulWidget {
  @override
  _DesigningServiceState createState() => _DesigningServiceState();
}

class _DesigningServiceState extends State<DesigningService> {
  ...
  List columns = [
    ...
    {'title': '设计类型', 'key': 'SERVICE_DESIGN_TYPE'},
    {'title': '设计风格', 'key': 'SERVICE_DESIGN_STYLE'},
