...
class StaffDepartmentContent extends StatefulWidget {
  final List ajaxData;
  final Function getData;
  final Map state;

  StaffDepartmentContent({this.ajaxData, this.getData, this.state});

  @override
  _StaffDepartmentContentState createState() => _StaffDepartmentContentState();
}

class _StaffDepartmentContentState extends State<StaffDepartmentContent> {
  BuildContext _context;
                  ...
                  con = Row(
                    children: <Widget>[
                      Container(
                        ...
                        child: Text('${widget.state[item['state']]}'),
                      ),
                      PrimaryButton(
                        onPressed: () {
                          stateDialog(item);
                        },
                        child: '${item['state']}' == '1' ? Icon(Icons.play_arrow) : Icon(Icons.stop),
                      ),
                    ],
                  );
                  break;
